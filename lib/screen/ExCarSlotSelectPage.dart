...
class CarSlot {
  ...
  CarSlot({required this.id, this.isBooked = false});
}

class CarSlotSelectController extends GetxController {
  RxList<CarSlot> slots = <CarSlot>[
    CarSlot(id: 'B2'),
    CarSlot(id: 'B3'),
    CarSlot(id: 'B4'),
    CarSlot(id: 'B6'),
...
class CarSlotSelectsPage extends StatelessWidget {
  final CarSlotSelectController controller = Get.put(CarSlotSelectController());

  CarSlotSelectsPage({super.key});
