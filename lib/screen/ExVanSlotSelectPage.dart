...
class VanSlot {
  ...
  VanSlot({required this.id, this.isBooked = false});
}

class VarSlotSelectController extends GetxController {
  RxList<VanSlot> slots = <VanSlot>[
    VanSlot(id: 'B2'),
    VanSlot(id: 'B3'),
    VanSlot(id: 'B4'),
    VanSlot(id: 'B6'),
...
class VanSlotSelectsPage extends StatelessWidget {
  final VarSlotSelectController controller = Get.put(VarSlotSelectController());

  VanSlotSelectsPage({super.key});
